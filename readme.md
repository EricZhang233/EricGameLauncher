...
<div align="center">
  <img src=".github/readmeres/readmescrsoot1.png" width="100%" />
  <img src=".github/readmeres/readmescrsoot2.png" width="100%" />
</div>
...
*   **拼音秒搜**：专为中文环境优化。想玩《英雄联盟》？只需输入 "LOL" 或 "YXLM"，结果即刻呈现。
...
## 特别致谢 / 友情链接
*   [**Starward**](https://github.c/Scighost/Starward): 一个功能强大的米哈游游戏启动器。我们最初的对此项目的构想只是一个本地游戏的集合启动器，没计划支持分发平台。一开始之所以支持url-scheme协议，就是因为需要支持他的协议来支持记录米家游戏游戏时长。后来想了想既然都支持了url-scheme了，那就支持一下诸如Steam/Epic等平台的协议吧，结果就有了现在这个支持分发平台启动器的功能。此项目不在于替代starward，而是提供一个极简的游戏启动器，满足一些玩家不需要过多功能，只需要一个纯粹的启动工具的需求。Starward在米哈游游戏启动器领域的创新和贡献是不可磨灭的，我们希望通过支持其协议来向其致敬，并为玩家提供更多选择。借由这个契机，我们的启动器应该能支持绝大部分的启动器url-scheme协议和带参执行。
