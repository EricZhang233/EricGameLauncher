经过一段时间的打磨，Eric Game Launcher (EGL) 终于迎来了第一个公测版本 **v1.5.0**！
这是一个专为极简主义者打造的现代化游戏启动器，旨在让启动游戏这件事回归纯粹与极速。
## 功能特性
...
*   **现代化构建**：
    ...
    *   **框架依赖 (Framework-Dependent)**：充分利用系统已安装的 .NET 运行时，保持发布体积极其小巧。
...
4.  点击右上角 **“更多” -> “添加”**，选择游戏快捷方式或可执行文件。
5.  *(推荐)* 在设置中开启“便携模式”，体验绿色软件的快乐。
